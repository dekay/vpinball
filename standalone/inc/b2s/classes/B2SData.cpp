...
{
   return m_valid && (GetUseRomLamps() || GetUseAnimationLamps());
}

bool B2SData::GetSolenoidsData()
{
   return m_valid && (GetUseRomSolenoids() || GetUseAnimationSolenoids());
}

bool B2SData::GetGIStringsData()
{
   return m_valid && (GetUseRomGIStrings() || GetUseAnimationGIStrings());
}

bool B2SData::GetLEDsData()
{
   return m_valid && (GetUseLEDs() || GetUseLEDDisplays() || GetUseReels());
}
